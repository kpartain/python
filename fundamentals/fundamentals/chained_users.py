...
karaUser.make_deposit(500).make_withdrawal(200).display_user_balance()

testUser = User("Testman", "Test@Test.com")
testUser.make_deposit(100).display_user_balance()

karaUser.transfer_money(testUser, 100).display_user_balance()
