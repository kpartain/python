...
class SLList {
    ...
    isCircular() {
        ...
        var couchPotato = this.head.next;
        if(couchPotato.next == null) {
            return false;
        }
        var activePotato = couchPotato.next;
        while (activePotato != null){
            if (activePotato == couchPotato){
                return true;
            }
            activePotato = activePotato.next;
        }
        return false;
    }
}
...
console.log(list1.isCircular()) // Should return true
console.log(list2.isCircular()) // Should return false